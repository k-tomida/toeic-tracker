            ...
            {sortScoreData.length === 0 ? (
                ...
                <div className="w-full border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <table className="w-full min-w-[760px] border-collapse">
                            <thead>
                                <tr className="text-left text-sm text-emerald-900 bg-emerald-50">
                                    <th className="py-3 px-4 font-medium w-32">受験日</th>
                                    <th className="py-3 px-4 font-medium w-20">L</th>
                                    <th className="py-3 px-4 font-medium w-20">R</th>
                                    <th className="py-3 px-4 font-medium w-24">合計</th>
                    ...
                    <div className="flex flex-col items-center gap-3 px-4 py-3 border-t border-gray-100 bg-gray-50 text-sm text-gray-500 sm:flex-row sm:justify-between">
                        <span>
                            全{sortScoreData.length}件中 {startItem}〜{endItem}件表示
                        </span>
