...
export const CategoryBreakdown = ({ studySessions }: { studySessions: studySessionType[] }) => {
    ...
    return (
        <div className="w-full bg-white rounded-xl p-4 border border-gray-300 flex-1 min-w-0">
            ...
            <div>
                <div className="flex items-center gap-2 sm:gap-4 mb-6 justify-between">
                    ...
                    <span className="w-12 shrink-0 text-right">{calcStudyTimeByCategory("VOCABULARY", studySessions)}h</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-4 mb-6 justify-between">
                    ...
                    <span className="w-12 shrink-0 text-right">{calcStudyTimeByCategory("GRAMMAR", studySessions)}h</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-4 mb-6 justify-between">
                    ...
                    <span className="w-12 shrink-0 text-right">{calcStudyTimeByCategory("LISTENING", studySessions)}h</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-4 mb-5 justify-between">
                    ...
                    <span className="w-12 shrink-0 text-right">{calcStudyTimeByCategory("MOCK_EXAM", studySessions)}h</span>
                </div>
            </div>
            <div className="text-lg sm:text-xl flex items-center gap-2 mb-5 justify-between border border-transparent border-t-gray-300 pt-5">
