...
export const HomePage = () => {
  ...
  if (userQuery.isLoading || studySessionQuery.isLoading || scoreQuery.isLoading) return <div>読み込み中...</div>;
  if (userQuery.isError || studySessionQuery.isError || scoreQuery.isError ||
    !userQuery.data || !studySessionQuery.data || !scoreQuery.data) return <div>データの取得に失敗しました</div>;
  return (
    <div className="min-h-screen ">
      <Header />
      <main className="max-w-7xl mx-auto px-4 py-6">
        <KpiCards studySessions={studySessionQuery.data} scores={scoreQuery.data} />
